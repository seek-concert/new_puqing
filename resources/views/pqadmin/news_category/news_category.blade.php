    ...
    <div class="contents">
        <div class="grid_wrapper">
            <div class="g_6 contents_header">
                <h3 class="i_16_table tab_label">新闻分类</h3>
                <div><span class="label">查看所有新闻分类</span></div>
            </div>
            ...
            <div class="g_12">
                <div class="widget_header wwOptions">
                    <h4 class="widget_header_title wwIcon i_16_data">新闻分类</h4>
                    <div class="w_Options i_16_settings">
                        <!-- Drop Menu -->
                        <ul class="drop_menu menu_with_icons right_direction">
                            <li>
                                <a class="i_16_add" href="{{url('pqadmin/news_category_add')}}" title="New Flie">
                    ...
                    <table class="datatable tables">
                        ...
                        @foreach ($list as $value)
                            <tr>
                                ...
                                <td>{{$value->name}}</td>
                                <td>
                                    <a href="{{url('pqadmin/news_category_edit',[$value->id])}}">
    ...
    <script>
        function customer_del(id) {
            var d = dialog({
                ...
                ok: function () {
                    $.ajaxSetup({
                        url: "{{url('pqadmin/news_category_del')}}" + "/" + id,
                        headers: {
