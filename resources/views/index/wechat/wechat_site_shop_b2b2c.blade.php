...
@section('content')
    ...
    <section class="commom-navs">
        <div class="commom-navs-content">
            ...
            <a href="{{asset('/wechat_site_shop_b2b2c')}}" class="commom-navs-content__item active">
                <div class="commom-navs-content__icon iconfont">&#xe807;</div>
    ...
    <section class="main-wrap">
        <div class="container-fluid">
            <div class="main-subtitle row pt-3">
                ...
                <a href="#" class="active" title="微B2B2C商城详情">微B2B2C商城</a>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8">
                    ...
                    <div class="w-100 pt-3">
                        <img src="{{asset('index/images/website/b2b2c-img3.jpg')}}" alt="B2B2C商城业务概述" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
