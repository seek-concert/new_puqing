...
@section('content')
    ...
    <section class="commom-navs">
        <div class="commom-navs-content">
            <a href="{{asset('/wechat_site_shop_web')}}" class="commom-navs-content__item">
            ...
            <a href="{{asset('/wechat_site_shop_sale')}}" class="commom-navs-content__item active">
                <div class="commom-navs-content__icon iconfont">&#xe612;</div>
    ...
    <section class="main-wrap">
        <div class="container-fluid">
            <div class="main-subtitle row pt-3">
                ...
                <a href="#" class="active" title="微分销商城详情">微分销商城</a>
            </div>
        </div>
    </section>
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h1>多终端展现 玩赚分销</h1>
                    <div class="w-100">
                        <img src="{{asset('index/images/website/shopsale-img2.png')}}" alt="微分销商城" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container text-center text-white">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10">
                    ...
                    <div class="w-100"><img src="{{asset('index/images/website/shopsale-img7.png')}}" alt="微商城促销"
                                            class="img-fluid"></div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 mt-md-5">
                <div class="w-100 m-auto d-none d-lg-block"><img
                            src="{{asset('index/images/website/shopsale-img8.jpg')}}" alt="微商城子店"></div>
                <div class="wrap-step">
