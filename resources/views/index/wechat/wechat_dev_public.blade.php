        ...
        <div class="row">
          ...
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img1.png" alt="">
              <h6>移动互联网趋势</h6>
            </div>
          </div>
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img2.png" alt="">
              <h6>巨大流量入口</h6>
            </div>
          </div>
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img3.png" alt="">
              <h6>强大的用户粘性和使用惯性</h6>
            </div>
          </div>
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img4.png" alt="">
              <h6>差异化服务</h6>
            </div>
          </div>
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img5.png" alt="">
              <h6>时尚的产品销售渠道</h6>
            </div>
          </div>
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img6.png" alt="">
              <h6>高效CRM管理</h6>
            </div>
          </div>
          <div class="small-wrap-count__col">
            <div class="small-wrap-count__item">
              <img src="./images/wechatdev/nopublic/we_img7.png" alt="">
              <h6>低成本营销</h6>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-12 col-md-6">
          <div class="small-wrap-service">
            <div class="small-wrap-service__img">
              <img src="./images/wechatdev/nopublic/sp_img1.png" alt="">
            </div>
        ...
        <div class="col-12 col-md-6">
          <div class="small-wrap-service">
            <div class="small-wrap-service__img">
              <img src="./images/wechatdev/nopublic/sp_img2.png" alt="">
            </div>
            <div class="small-wrap-service__cont">
              <h5>微信订阅号开发</h5>
        ...
        <div class="col-12 col-md-6">
          <div class="small-wrap-service">
            <div class="small-wrap-service__img">
              <img src="./images/wechatdev/nopublic/sp_img3.png" alt="">
            </div>
            <div class="small-wrap-service__cont">
              <h5>微信企业号开发</h5>
      ...
      <div class="row">
        ...
        <div class="small-wrap-feature">
          <div class="small-wrap-feature__box small-wrap-feature__box1">
            <img src="./images/wechatdev/nopublic/fea_img1.png" alt="">
            <h5>微信H5页面制作</h5>
          </div>
          <div class="small-wrap-feature__box small-wrap-feature__box2">
            <img src="./images/wechatdev/nopublic/fea_img2.png" alt="">
            <h5>微官网开发</h5>
          </div>
          <div class="small-wrap-feature__box small-wrap-feature__box3">
            <img src="./images/wechatdev/nopublic/fea_img3.png" alt="">
            <h5>微信支付功能开发</h5>
          </div>
          <div class="small-wrap-feature__box small-wrap-feature__box4">
            <img src="./images/wechatdev/nopublic/fea_img4.png" alt="">
            <h5>微信预约功能开发</h5>
          </div>
          <div class="small-wrap-feature__box small-wrap-feature__box5">
            <img src="./images/wechatdev/nopublic/fea_img5.png" alt="">
            <h5>微分销系统开发</h5>
          </div>
        </div>
      </div>
