...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('index/css/web-site-shop.css')}}">
@endsection
...
@section('content')
    ...
    <section class="commom-navs">
        <div class="commom-navs-content">
            <a href="{{url('/web_site_shop_web')}}" class="commom-navs-content__item active">
    ...
    <section class="main-wrap">
        <div class="container-fluid">
            <div class="main-subtitle row pt-3">
                ...
                <a href="#" class="active" title="重庆B2B商城">B2B商城</a>
    ...
    <section class="shop-wrap shop-wrap-webbg1">
        <div class="container text-center text-white">
            ...
            <div class="w-100 pt-3">
                <img src="{{asset('index/images/website/b2b-img2.png')}}" alt="B2B商城建设" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section class="shop-wrap">
        <div class="container text-center">
            <h1>普擎B2B<span class="text-danger">业务</span>流程图</h1>
            <p>
            ...
            <div class="w-100 pt-3">
                <img src="{{asset('index/images/website/b2b-img3.jpg')}}" alt="B2B商城流程" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section class="shop-wrap">
        <div class="container text-center">
            <h1>B2B电子商务网站<span class="text-success">特点</span></h1>
            <p>
            ...
            <div class="w-100">
                <img src="{{asset('index/images/website/b2b-img4.jpg')}}" alt="B2B商城特点" class="img-fluid">
            </div>
        </div>
    </section>
    ...
    <section class="shop-wrap shop-wrap-webbg2">
        <div class="container text-center text-white">
            ...
            <div class="w-100 pt-3">
                <img src="{{asset('index/images/website/b2b-img5.png')}}" alt="B2B商城发展趋势" class="img-fluid">
            </div>
        </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-0 order-12">
                <div class="shop-wrap-content">
                    ...
                    <div class="w-100">
                        <img src="{{asset('index/images/website/b2b-img7.jpg')}}" alt="B2B商城行业应用" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
