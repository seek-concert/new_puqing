...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('index/css/bootstrap-reboot.min.css')); ?>">
...
<header class="main-header">
    <div class="main-view">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="/" title="首页跳转"><img src="<?php echo e(asset('index/images/logo.png')); ?>" alt="普擎科技 LOGO"></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/web')); ?>">网站建设</a>
                        <span class="hot iconfont">&#xe7a8;</span>
                        <div class="childnav">
                            <div class="main-view d-flex align-items-center">
                                <div class="childnav-left">
                                    <img src="<?php echo e(asset('index/images/website/Laptosss.png')); ?>" alt="">
                                </div>
                                <div class="childnav-right">
                                    <a href="<?php echo e(url('/web')); ?>?index=0" class="childnav-link">
                                        <div class="childnav-link-icon"><img src="<?php echo e(asset('index/images/website/Bag.png')); ?>" alt=""></div>
                                        <div class="childnav-link-name"><span>——</span> 商城网站 </div>
                                    </a>
                                    <a href="<?php echo e(url('/web')); ?>?index=1" class="childnav-link">
                                        <div class="childnav-link-icon"><img src="<?php echo e(asset('index/images/website/Laptop.png')); ?>" alt=""></div>
                                        <div class="childnav-link-name"><span>——</span> 企业官网 </div>
                                    </a>
                                    <a href="<?php echo e(url('/web')); ?>?index=2" class="childnav-link">
                                        <div class="childnav-link-icon"><img src="<?php echo e(asset('index/images/website/mobilephole.png')); ?>" alt=""></div>
                                        <div class="childnav-link-name"><span>——</span> 手机网站 </div>
                                    </a>
                                    <a href="<?php echo e(url('/web')); ?>?index=3" class="childnav-link">
                                        <div class="childnav-link-icon"><img src="<?php echo e(asset('index/images/website/Home.png')); ?>" alt=""></div>
                                        <div class="childnav-link-name"><span>——</span> 门户网站 </div>
                                    </a>
                                    <a href="<?php echo e(url('/web')); ?>?index=4" class="childnav-link">
                                        <div class="childnav-link-icon"><img src="<?php echo e(asset('index/images/website/Monitor.png')); ?>" alt=""></div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/wechat')); ?>">微信开发</a>
                        <span class="hot iconfont">&#xe7a8;</span>
                        <div class="childnav wechatnav">
                            <div class="main-view d-flex text-center">
                                <a href="<?php echo e(url('/wechat')); ?>?index=0" class="wechatnav-item border-right">
                                    <div class="p-5">
                                        <i class="iconfont">&#xe600;</i>
                                        <h3>公众号</h3>
                                    </div>
                                </a>
                                <a href="<?php echo e(url('/wechat')); ?>?index=1" class="wechatnav-item border-right">
                                    <div class="p-5">
                                        <i class="iconfont">&#xe611;</i>
                                        <h3>小程序</h3>
                                    </div>
                                </a>
                                <a href="<?php echo e(url('/wechat')); ?>?index=2" class="wechatnav-item border-right">
                                    <div class="p-5">
                                        <i class="iconfont">&#xe650;</i>
                                        <h3>微商城</h3>
                                    </div>
                                </a>
                                <a href="<?php echo e(url('/wechat')); ?>?index=3" class="wechatnav-item">
                                    <div class="p-5">
                                        <i class="iconfont">&#xe6f3;</i>
                                        <h3>微服务</h3>
                                    </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/app')); ?>">软件定制</a>
                        <span class="hot iconfont">&#xe7a8;</span>
                                ...
                                <div class="childnav-left">
                                    ...
                                    <div class="softnav-left">
                                        <div class="softnav-left-item">
                                            <img src="<?php echo e(asset('index/images/solu1.png')); ?>" alt="">
                                        ...
                                        <div class="softnav-left-item">
                                            <img src="<?php echo e(asset('index/images/solu2.png')); ?>" alt="">
                                            <div class="softnav-left-cont">
                                                <h5>移动电商行业</h5>
                                        ...
                                        <div class="softnav-left-item">
                                            <img src="<?php echo e(asset('index/images/solu3.png')); ?>" alt="">
                                            <div class="softnav-left-cont">
                                                <h5>数字金融行业</h5>
                                        ...
                                        <div class="softnav-left-item">
                                            <img src="<?php echo e(asset('index/images/solu4.png')); ?>" alt="">
                                            <div class="softnav-left-cont">
                                                <h5>网络营销行业</h5>
                                ...
                                <div class="childnav-right">
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-oriapp" role="tabpanel"
                                            ...
                                            <img src="<?php echo e(asset('index/images/softcreat/soft-img1.png')); ?>" alt="">
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-items" role="tabpanel" aria-labelledby="v-pills-items-tab">
                                            <img src="<?php echo e(asset('index/images/softcreat/soft-img3.png')); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/case')); ?>">成功案例</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/news')); ?>">新闻资讯</a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="<?php echo e(url('/about')); ?>">关于普擎</a>
                    </li>
                </ul>
            </div>
        </nav>
...
<div class="dual dual-right">
    <ul>
        ...
        <li>
            <div class="dual-ewm">
                <img src="<?php echo e(asset('index/images/wx.jpg')); ?>" alt="">
            </div>
            <em class="iconfont">&#xeba1;</em>
        </li>
        <li id="sTop">
...
<!-- js -->
<script type="text/javascript" src="<?php echo e(asset('index/js/lib/jquery-1.9.0.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('index/js/lib/bootstrap.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('index/js/config.js')); ?>"></script>
