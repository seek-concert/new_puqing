<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('index/css/swiper.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('index/css/animate.min.css')); ?>">
    ...
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            ...
            <section class="banner swiper-container swiper-container-h">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('index/images/banner.jpg')); ?>" alt="banner1">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('index/images/banner.jpg')); ?>" alt="banner2">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('index/images/banner.jpg')); ?>" alt="banner3">
                    </div>
                </div>
                <!-- Add Pagination -->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12 pb-3">
                                <div class="card ani" swiper-animate-effect="slideInUp" swiper-animate-duration="0.5s"
                                     swiper-animate-delay="0.2s">
                                    <img class="card-img-top" src="<?php echo e(asset('index/images/solu1.png')); ?>" alt="">
                                    <div class="card-body">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12 pb-3">
                                <div class="card ani" swiper-animate-effect="slideInUp" swiper-animate-duration="0.5s"
                                     swiper-animate-delay="0.4s">
                                    <img class="card-img-top" src="<?php echo e(asset('index/images/solu2.png')); ?>" alt="">
                                    <div class="card-body">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12 pb-3">
                                <div class="card ani" swiper-animate-effect="slideInUp" swiper-animate-duration="0.5s"
                                     swiper-animate-delay="0.6s">
                                    <img class="card-img-top" src="<?php echo e(asset('index/images/solu3.png')); ?>" alt="">
                                    <div class="card-body">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12 pb-3">
                                <div class="card ani" swiper-animate-effect="slideInUp" swiper-animate-duration="0.5s"
                                     swiper-animate-delay="0.8s">
                                    <img class="card-img-top" src="<?php echo e(asset('index/images/solu4.png')); ?>" alt="">
                                    <div class="card-body">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 pb-3">
                                        <div class="card ani" swiper-animate-effect="fadeInDown" swiper-animate-duration="0.5s"
                                            ...
                                            <div class="card-img-top">
                                                <img class="" src="<?php echo e(asset('index/images/case8.jpg')); ?>" width="100%" height="100%" alt="Card image cap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 order-md-12 order-1 d-flex justify-content-center align-items-center">
                                <div class="about-right ani" class="ani" swiper-animate-effect="fadeInRight"
                                    ...
                                    <img src="<?php echo e(asset('index/images/about-img.png')); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="0.2s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part1.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="0.4s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part2.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="0.6s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part3.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="0.8s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part4.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="1s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part5.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="1.2s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part6.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="1.4s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part7.jpg')); ?>" width="100%" alt=""></a></div>
                            <div class="col-sm-3 col-6 pb-3 ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s"
                                 swiper-animate-delay="1.6s"><a href="http://www.lanceyi.com" target="_blank"><img
                                            src="<?php echo e(asset('index/images/part8.jpg')); ?>" width="100%" alt=""></a></div>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <!-- footer -->
            <?php echo $__env->make('index.public.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <!-- footer end -->
    </div>
    <!-- Add Pagination -->
...
<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(asset('index/js/lib/swiper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('index/js/lib/swiper.animate.min.js')); ?>"></script>
    <script src="<?php echo e(asset('index/js/main.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('index.public.layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>